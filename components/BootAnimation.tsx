  ...
  return (
    <AnimatePresence>
      {stage < 3 && (
        ...
        >
          {/* Ambient Background Gradient (Removed to let the body gradient shine through) */}
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 w-full max-w-lg">
            ...
            {stage >= 1 && (
              ...
              >
                <div className="relative w-28 h-28 bg-white/20 backdrop-blur-md rounded-[2rem] flex items-center justify-center text-white text-5xl font-black shadow-[0_0_40px_rgba(255,255,255,0.4)] border border-white/50 overflow-hidden group">
                  <motion.div 
                    initial={{ x: "-100%" }}
                    animate={{ x: "100%" }}
                  ...
                  />
                  <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-200 drop-shadow-lg">
                    TT
                  </span>
                </div>
              </motion.div>
            ...
            {stage >= 2 && (
              ...
              >
                <div className="space-y-1">
                    <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-white">
                      TT APP
                    </h1>
                    <h2 className="text-sm md:text-base font-medium text-white/90 tracking-wide drop-shadow-sm">
                ...
                <motion.div 
                  ...
                  className="flex items-center justify-center gap-2 text-[10px] sm:text-xs text-white bg-white/20 backdrop-blur-md py-1.5 px-3 rounded-full mx-auto w-fit border border-white/30 shadow-inner"
                >
                ...
                <motion.div
                  ...
                  className="text-white/70 text-[10px] sm:text-xs font-semibold tracking-[0.2em] sm:tracking-[0.3em] uppercase pt-4 drop-shadow-md"
                >
                  ...
                  <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.7 }} className="text-white">Achieve.</motion.span>
                </motion.div>
              </motion.div>
            )}
          </div>
